...
\vspace{0.4cm}
Généralisation aux options en dehors de la monnaie (OTM) :
...
\begin{itemize}[label=$\rightarrow$]
    ...
    \item La dette initiale a accumulé des intérêts au taux $r$. Le montant à rembourser est de : $e^{-dT} S_0 \times e^{rT} = S_0 e^{(r-d)T}$.
\end{itemize}
