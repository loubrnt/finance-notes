...
Pour conserver la validité de la theory de l'arbitrage, nous devons utiliser les prix actualisés. La règle d'or devient : la valeur initiale de n'importe quel portefeuille est égale à l'espérance de sa valeur future, divisée par le facteur de capitalisation de l'actif sans risque.
\end{remarquebox}
